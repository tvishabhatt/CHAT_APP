...
class ChatScreenState extends State<ChatScreen>with ForFuncations {
                ...
                builder: (context, snapshot) {
                  if(!snapshot.hasData){
                    ...
                    return ListView.builder(
                      itemBuilder: (context, index) =>MessageItem(index, messages[index]) ,
        ...
        child: Expanded(
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              color: (documentSnapshot.get('senderId') == user!.uid) ? foryou() :forme(),
            ),
            child: Column(
              children: [
  ...
  Future<void> sendMessage(String senderId, String receiverId, String message, String senderEmail, String receiverEmail,) async {
    if (message.isNotEmpty) {
      ...
      DocumentSnapshot chatDoc = await db.collection(collectionNameOfChatrooms).doc(chatRoomId).get();
      if (!chatDoc.exists) {
        await db.collection(collectionNameOfChatrooms).doc(chatRoomId)
...
//       if (!chatDoc.exists) {
//         await db.collection("CHAT_ROOMS").doc(chatRoomId)
//             .collection("MESSAGES")
//             .add({
//           'senderId': senderId,
